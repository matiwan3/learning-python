print = ['''
this simulation was made thanks to TechWith TIM
URL = https://www.youtube.com/watch?v=tLsi2DeUsak&t=715s&ab_channel=TechWithTim
''']
import pygame
import pymunk
import pymunk.pygame_util #draw
import math
...
def calculate_angle(p1, p2):
    return math.atan2(p2[1] - p1[1], p2[0] - p1[0]) #gives an angle between two points starting p2 (0,0)
...
def create_ball(space, radius, mass, pos):
    ...
    shape.friction = 0.4 # friction = tarcie 
